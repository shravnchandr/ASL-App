...
_GRAMMAR_SYSTEM_PROMPT = (
    ...
    "### 11. Numbers\n"
    "ASL has distinct handshape signs for numbers. Apply these rules:\n"
    "- Quantities and counts: use the digit(s) as a gloss — '3 cats' → '3 CAT', "
    "'I have 5 brothers' → 'I BROTHER 5 HAVE'\n"
    "- Years: split into two 2-digit chunks — '2030' → '20 30', '1999' → '19 99', "
    "'2005' → '20 5'\n"
    "- Ages: single number — '25 years old' → 'AGE 25'\n"
    "- Money: number then DOLLAR or CENT — '$50' → '50 DOLLAR', '25 cents' → '25 CENT'\n"
    "- Phone numbers, zip codes, ID/serial numbers: fingerspell digit by digit — "
    "'617-555-1234' → 'fs-6-1-7 fs-5-5-5 fs-1-2-3-4', 'zip 02134' → 'fs-0-2-1-3-4'\n"
    "- Building/address numbers: treat as a quantity, not fingerspelled — "
    "'42 Main Street' → '42 fs-MAIN STREET'\n"
    "- NEVER use fs- on years, ages, money, or plain quantities — those have number signs\n\n"
    "## GLOSS CONVENTIONS\n"
    ...
    "- 'The year is 2030' → 'YEAR 20 30'\n"
    "- 'I was born in 1995' → 'I 19 95 BORN'\n"
    "- 'Call me at 617-555-1234' → 'YOU CALL-ME fs-6-1-7 fs-5-5-5 fs-1-2-3-4'\n"
    "- 'It costs $20' → 'COST 20 DOLLAR'\n"
    "- 'She is 30 years old' → 'SHE AGE 30'\n"
    "- 'I have 3 cats' → 'I 3 CAT HAVE'\n\n"
